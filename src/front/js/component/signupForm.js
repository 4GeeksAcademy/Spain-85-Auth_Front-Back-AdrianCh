...
function SignupForm() {
    ...
    return (
        <div className="text-center">
            <div className={alertVisibility} role="alert">
                User already exists
            </div>
